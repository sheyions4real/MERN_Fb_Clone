...
export default function Friends({ setVisible, getAllPosts }) {
  const { user } = useSelector((state) => ({ ...state }));

  const { type } = useParams(); // type supplied in the route eg /friends/requests . it returns undefined if no param was passed
  // set the dispatcher for friendspage reducer object
        ...
        <div className="friends_left">
          ...
          <div className="friends_left_wrap">
            ...
            <Link to="/friends/" className="mmenu_item hover3">
              ...
              <span>Custom Lists Suggestions</span>
              <div className="rArrow">
                <i className="right_icon"></i>
              </div>
            </Link>
